  ...
  async seedBadges(): Promise<void> {
    ...
    const badgesToSeed: InsertBadge[] = [
      ...
      },
      {
        ...
        icon: "⭐",
        category: "MILESTONE",
        description: "You've mastered the basics! Ready for greater adventures.",
        criteria: "Reach Level 4 (600 XP)",
        xpRequired: 600,
      },
      {
        name: "Globetrotter",
        icon: "🌍",
        category: "EXPLORATION",
        description: "The world is your playground! You've become an experienced traveler.",
        criteria: "Reach Level 5 (1000 XP)",
        xpRequired: 1000,
      },
      {
        ...
        icon: "🚀",
        category: "MILESTONE",
        description: "Exceptional dedication to exploration! You're an inspiration to fellow travelers.",
        criteria: "Reach Level 6 (1500 XP)",
        xpRequired: 1500,
      },
      {
      ...
      {
        name: "Local Guides Connector",
        icon: "🔗",
        category: "SOCIAL",
        description: "Connected your Google Local Guides profile! Your contributions earn XP across platforms.",
        criteria: "Connect Google Local Guides profile",
        xpRequired: null,
      },
    ];
